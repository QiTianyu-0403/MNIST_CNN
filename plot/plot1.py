...
def draw(x, train_loss, train_acc, test_acc, train_loss1, train_acc1, test_acc1, train_loss2, train_acc2, test_acc2, args):
    ...
    plt.subplot(3, 1, 1)
    plt.grid()
    plt.plot(x, train_loss, color='#1f77b4', label='lr=0.002')
    plt.plot(x, train_loss1, color='#ff7f0e', label='lr=0.01')
    plt.plot(x, train_loss2, color='#2ca02c', label='lr=0.1')
    plt.legend()
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    ...
    plt.subplot(3, 1, 2)
    plt.grid()
    plt.plot(x, train_acc, label='lr=0.002')
    plt.plot(x, train_acc1, label='lr=0.01')
    plt.plot(x, train_acc2, label='lr=0.1')
    plt.legend()
    plt.xlabel('Epochs')
    plt.ylabel('Acc')
    ...
    plt.subplot(3, 1, 3)
    plt.grid()
    plt.plot(x, test_acc, label='lr=0.002')
    plt.plot(x, test_acc1, label='lr=0.01')
    plt.plot(x, test_acc2, label='lr=0.1')
    plt.legend()
    plt.xlabel('Epochs')
    plt.ylabel('Acc')
...
def main():
    ...
    train_path1 = "./log_" + args.model + "_" + args.data + "1.txt"
    test_path1 = "./acc_" + args.model + "_" + args.data + "1.txt"
    train_path2 = "./log_" + args.model + "_" + args.data + "2.txt"
    test_path2 = "./acc_" + args.model + "_" + args.data + "2.txt"
    ...
    draw(x, train_loss, train_acc, test_acc, train_loss1, train_acc1, test_acc1, train_loss2, train_acc2, test_acc2, args)
